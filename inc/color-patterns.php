<?php
/**
 * JT ABCServiTodo: Color Patterns
 *
 * @package WordPress
 * @subpackage jtabcservitodo
 * @since 1.0
 */
 ...
 */
function jtabcservitodo_custom_colors_css() {
	...
	/**
	 * Filter JT ABCServiTodo default saturation level.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'jtabcservitodo_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter JT ABCServiTodo default selection saturation level.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'jtabcservitodo_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter JT ABCServiTodo default lightness level.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'jtabcservitodo_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter JT ABCServiTodo default hover lightness level.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'jtabcservitodo_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter JT ABCServiTodo default selection lightness level.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'jtabcservitodo_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters JT ABCServiTodo custom colors CSS.
	 *
	 * @since JT ABCServiTodo 1.0
	 *
	 ...
	 */
	return apply_filters( 'jtabcservitodo_custom_colors_css', $theme_css, $primary_color, $saturation );
}
